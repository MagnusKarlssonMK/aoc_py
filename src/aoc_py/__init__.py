...
def main() -> None:
    ...
    _ = parser.add_argument("year", type=int, help="Year, 4 digits")
    _ = parser.add_argument("day", type=int, help="Day, 2 digits")
    _ = parser.add_argument(
        "--part", type=int, choices=[1, 2], default=None, help="Run only part 1 or 2"
    )
